    ...
    async def commit_loop(self):
        ...
        for message in starboard.keys():
            if starboard[message]["ori_chan_id"] == None:
                ...
                ori_reactors = starboard[message]['ori_reactors'] if starboard[message]['ori_reactors'] != "" else "NULL"
                var_reactors = starboard[message]['var_reactors'] if starboard[message]['var_reactors'] != "" else "NULL"
